...
# 京东
# 商品id获取, 查看商品详情触发通知
https:\/\/.+\.jd\.com\/graphext\/draw\?sku=(\d+).* url script-request-header https://github.com/canonvip/Rules/raw/refs/heads/main/script/jd/jdapp_chain_link.js
https:\/\/.+\.jd\.com\/product\/.*\/(\d+)\.html url script-request-header https://github.com/canonvip/Rules/raw/refs/heads/main/script/jd/jdapp_chain_link.js
[mitm]
hostname = *.jd.com, *.*.jd.com
*/
const chen = new Env('京品库'); 
